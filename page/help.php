                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            <li class="nav-item">
                                <a href="#buat-tiket" data-toggle="tab" aria-expanded="false" class="nav-link">
                                    ...
                                    <span class="d-none d-sm-block">Buat Tiket</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="#daftar-tiket" data-toggle="tab" aria-expanded="false" class="nav-link active">      
                                    ...
                                    <span class="d-none d-sm-block">Daftar Tiket</span>
                                </a>
                            </li>
                        </ul>
                        <div class="tab-content">
							...
							<div class="alert alert-warning">
							    <div class="alert-text">
									<h5 class="text-uppercase text-white">Tata Cara Pengisian Form Subjek</h5><br />
