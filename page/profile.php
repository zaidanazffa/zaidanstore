...
?>
        ...
        <div class="kt-widget kt-widget--user-profile-1">
            <div class="kt-widget__head">
                <div class="kt-widget__media">
                    <img src="<?php echo $config['web']['url'] ?>assets/media/icon/user.jpg" alt="image">
                </div>
                <div class="kt-widget__content">
                    ...
                    <div class="kt-widget__action">
                        <button type="button" class="btn btn-info btn-sm">Koinku <?php echo number_format($data_user['koin'],0,',','.'); ?></button>
                    </div>
                </div>
            </div>
            <div class="kt-widget__body">
                <div class="kt-widget__content">
                    <div class="kt-widget__info">
                        ...
                        <span class="kt-widget__data"><?php echo $data_user['email']; ?></a>
                    </div>
                    <div class="kt-widget__info">
                ...
                <div class="kt-widget__items">
                    <a href="#account" data-toggle="tab" aria-expanded="false" class="nav-link kt-widget__item">
                    ...
                    <a href="#change-password" data-toggle="tab" aria-expanded="false" class="nav-link kt-widget__item">
                        <span class="kt-widget__section">
                            <span class="kt-widget__icon">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <a href="#change-pin" data-toggle="tab" aria-expanded="false" class="nav-link kt-widget__item">
                        <span class="kt-widget__section">
                            <span class="kt-widget__icon">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <a href="#setting-api" data-toggle="tab" aria-expanded="false" class="nav-link kt-widget__item">
                        <span class="kt-widget__section">
                            <span class="kt-widget__icon">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <!-- Start Change PIN -->
        <div role="tabpanel" class="tab-pane fade" id="change-pin">
            <div class="row">
                <div class="col-xl-12">
                    <div class="kt-portlet kt-portlet--height-fluid">
                        <div class="kt-portlet__head">
        ...
        <div role="tabpanel" class="tab-pane fade" id="setting-api">
            <div class="row">
                <div class="col-xl-12">
                    <div class="kt-portlet kt-portlet--height-fluid">
                        <div class="kt-portlet__head">
