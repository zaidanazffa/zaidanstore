                ...
                <div class="kt-widget kt-widget--user-profile-4">
                    <div class="kt-widget__head">
                        <div class="kt-widget__media">
                            <img class="kt-widget__img kt-hidden" src="<?php echo $config['web']['url'] ?>assets/media/icon/user.jpg" alt="image">
                        ...
                        <div class="kt-widget__content">
                            <div class="kt-widget__section">
                                ...
                                <div class="kt-widget__action text-center">                             
                                    ...
                                    <a href="https://wa.me/<?php echo $data_kontak['no_wa']; ?>" class="btn btn-icon btn-circle btn-label-instagram" target="_blank">
                        ...
                        <div class="kt-widget kt-widget--user-profile-2">
                            ...
                            <div class="kt-widget__body">
                                ...
                                <div class="kt-widget__item">
                                    ...
                                    <div class="kt-widget__contact">
                                        <span class="kt-widget__label">Nomor HP :</span>
                            ...
                            <div class="kt-widget__action text-center">                             
                                ...
                                <a href="https://wa.me/<?php echo $data_kontak['no_hp']; ?>"class="btn btn-icon btn-circle btn-label-instagram" target="_blank">
                                    <i class="flaticon-whatsapp"></i>
                                </a>                            
                            </div>
                        </div>         
