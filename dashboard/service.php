...
<body>
		                ...
		                <div class="box">
                            <h4 class="m-t-0 header-title text-center"><b>Daftar Harga Layanan Top Up</b></h4>
                                <form class="form-horizontal" role="form" method="POST">
									...
									<option value="SALGO">E-Money</option>
									<option value="PKIN">Data</option>
									<option value="PKSMS">Paket SMS Telpon</option>
									<option value="VGAME">Games</option>
									<option value="TOKENPLN">PLN</option>
									<option value="LAINYA">Pulsa Internasional</option>
        ...
        <footer class="footer">
            <div class="container text-center">
                <img src="<?php echo $config['web']['url'] ?>assets/media/logos/logo.png" alt="" height="55" width="55">
                <p>Copyright © 2016-2021 by <?php echo $data['short_title']; ?></p>
            </div>
        </footer>
        <!-- End Footer -->
