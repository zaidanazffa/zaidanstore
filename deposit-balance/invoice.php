		...
		<div class="kt-portlet">
            <div class="kt-portlet__body kt-portlet__body--fit">
                <div class="kt-invoice-1">
                    <div class="kt-invoice__head" style="background-image: url(<?php echo $config['web']['url'] ?>assets/media/bg/bg-4.jpg);">
                        <div class="kt-invoice__container">
                            <div class="kt-invoice__brand">
						        <h1 class="kt-invoice__title">INVOICE</h1>
                                <div href="#" class="kt-invoice__logo">
							        <a href="#"><img src="<?php echo $config['web']['url'] ?>assets/media/logos/logo.png" height="44" width="44"></a>
							        <span class="kt-invoice__desc">
								        <span>Alamat Kantor : <?php echo $data['lokasi']; ?></span>
								        <span>Kode Pos : <?php echo $data['kode_pos']; ?></span>
							        </span>
						        </div>
					        </div>
