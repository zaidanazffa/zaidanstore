        ...
        <div class="row">
            <div class="col-xl-12 m-b-30">
		        <div class="btn-group flex-wrap mb-4" role="group">
		            <a href="<?php echo $config['web']['url'] ?>history/order" class="btn btn-success active">Riwayat Sosial Media</a>
		        </div>
		        <div class="btn-group flex-wrap mb-4" role="group">
		            <a href="<?php echo $config['web']['url'] ?>history/order-pulsa" class="btn btn-danger active">Riwayat Top-Up</a>
		        </div>
			</div>
		</div>
        <div class="row">
...
if (isset($_GET['cari'])) {
    ...
    $cek_pesanan = "SELECT * FROM pembelian_pulsa WHERE id_order LIKE '%$cari_oid%' AND status LIKE '%$cari_status%' AND user = '$sess_username' ORDER BY id DESC"; // edit
} else {
...
?>
                                            <tr>
                                                ...
                                                <td><button class="view_all_order btn btn-primary btn-elevate btn-pill btn-elevate-air btn-sm" data-toggle="modal" id="<?php echo $data_pesanan['id']; ?>" data-target='#myDetailAll'><?php echo $data_pesanan['oid']; ?></button></td>
...
?>
                            ...
                            <!-- Start Tab History Order Social Media -->
			                <div role="tabpanel" class="tab-pane fade" id="social-media">
                                <form class="form-horizontal" method="GET">
                                    <div class="row">
                                        <div class="form-group col-lg-3">
                                            <label>Tampilkan Beberapa</label>
...
?>
                                            <tr>
                                                <td align="center"><?php if($data_pesanan['place_from'] == "API") { ?><i class="fa fa-random"></i><?php } else { ?><i class="flaticon-globe"></i><?php } ?></td>
                                                <td><button class="view_sosmed_order btn btn-primary btn-elevate btn-pill btn-elevate-air btn-sm" data-toggle="modal" id="<?php echo $data_pesanan['id']; ?>" data-target='#myDetailSosmed'><?php echo $data_pesanan['oid']; ?></button></td>
                                                <td><?php echo tanggal_indo($data_pesanan['date']); ?>, <?php echo $data_pesanan['time']; ?></td>
                                                <td><?php echo $data_pesanan['layanan']; ?></td>
                                                <td style="min-width: 200px;">
                                                <div class="input-group">
                                                ...
                                                <td><span class="btn btn-<?php echo $label2; ?> btn-elevate btn-circle btn-icon"><i class="fa fa-<?php echo $icon2; ?>"></i></span></td>
                                                <td align="center">
                                                    <a href="<?php echo $config['web']['url'] ?>page/receipt-social-media?oid=<?php echo $data_pesanan['oid']; ?>" class="btn btn-primary btn-elevate btn-circle btn-icon"><i class="fa fa-receipt"></i></a>
                                                </td>
                                            </tr>   
<?php } ?>
                                        </tbody>
...
?>
			                ...
			                <!-- End Tab History Order Social Media -->

                            <!-- Start Tab History Order Top Up -->
...
?>
                                            <tr>
                                                <td align="center"><?php if($data_pesanan['place_from'] == "API") { ?><i class="fa fa-random"></i><?php } else { ?><i class="flaticon-globe"></i><?php } ?></td>
                                                <td><button class="view_top_up_order btn btn-primary btn-elevate btn-pill btn-elevate-air btn-sm" data-toggle="modal" id="<?php echo $data_pesanan['id']; ?>" data-target='#myDetailTopUp'><?php echo $data_pesanan['oid']; ?></button></td>
                                                <td><?php echo tanggal_indo($data_pesanan['date']); ?>, <?php echo $data_pesanan['time']; ?></td>
                                                <td><?php echo $data_pesanan['layanan']; ?></td>
                                                <td style="min-width: 200px;">
                                                <div class="input-group">
                                                ...
                                                <td style="min-width: 200px;">
                                                <div class="input-group">
                                                    <input type="text" class="form-control form-control-sm" value="<?php echo $data_pesanan['keterangan']; ?>" id="keterangan-<?php echo $data_pesanan['oid']; ?>" readonly="">
                                                    <button data-toggle="tooltip" title="Copy Keterangan" class="btn btn-primary btn-sm" type="button" onclick="copy_to_clipboard('keterangan-<?php echo $data_pesanan['oid']; ?>')"><i class="fas fa-copy text-warning"></i></button>
                                                </div>
                                                </td>
                                                <td>Rp <?php echo number_format($data_pesanan['harga'],0,',','.'); ?></td>
                                                <td><span class="btn btn-<?php echo $label; ?> btn-elevate btn-pill btn-elevate-air btn-sm"><?php echo $data_pesanan['status']; ?></span></td>
                                                <td><span class="btn btn-<?php echo $label2; ?> btn-elevate btn-circle btn-icon"><i class="fa fa-<?php echo $icon2; ?>"></i></span></td>
                                                <td align="center">
                                                    <a href="<?php echo $config['web']['url'] ?>page/receipt-top-up?oid=<?php echo $data_pesanan['oid']; ?>" class="btn btn-primary btn-elevate btn-circle btn-icon"><i class="fa fa-receipt"></i></a>
                                                </td>
                                            </tr>   
<?php } ?>
                                        </tbody>
