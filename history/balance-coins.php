...
?>
                                <tr>
                                    ...
                                    <td><span class="kt-badge kt-badge--<?php echo $label; ?> kt-badge--md"><i class="<?php echo $icon; ?>"></i></span></td>
                                    <td width="20%"><span class="btn btn-<?php echo $label; ?> btn-elevate btn-pill btn-elevate-air btn-sm"><?php echo $view_data['aksi']; ?></span></td>
