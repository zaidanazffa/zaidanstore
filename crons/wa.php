...
require_once("../config.php");
    ...
    $harga_api = $data_harga_api['harga'];
            ...
            $phone = "+6289668258695";
            $text = "halo";
    $api_postdata = "phone=$phone&text=$text&apikey=$apikey2";
    $ch = curl_init();
    curl_setopt($ch, CURLOPT_URL, "https://api.callmebot.com/whatsapp.php");
...
// setting price 
$untung = (32 / 100) * $price; // keuntungan persen
...
$insert = $conn->query("INSERT INTO layanan_sosmed VALUES ('','$sid','$category2','$service2','$note','$min_order','$max_order','$harga_asli','$harga_api_asli','Aktif','$sid','SULTAN', 'Sosial Media')");//Memasukan Kepada Database (OPTIONAL)
if ($insert == TRUE) {
