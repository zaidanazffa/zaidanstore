...
?>
		...
		<nav class="navigation-bottom">
			<ul class="row navigation-bottom-wrapper">
				<li class="col-3 sideBox-item" style="background-color: #ffffff;">
					<a href="<?php echo $config['web']['url'] ?>">
						<i class="sideBox-item-icon flaticon-home-2" style="color: #00aaff;"></i>
					    <span class="sideBox-item-name"><font size="2">Beranda</font></span>
					</a>
				</li>
				<li class="col-3 sideBox-item" style="background-color: #ffffff;">
					<a href="<?php echo $config['web']['url'] ?>deposit-balance/">
						<i class="sideBox-item-icon flaticon-add-circular-button" style="color: #00aaff;"></i>
					    <span class="sideBox-item-name"><font size="2">Isi Saldo</font></span>
					</a>
				</li>
				<li class="col-3 sideBox-item" style="background-color: #ffffff;">
					<a href="<?php echo $config['web']['url'] ?>history/order">
						<i class="sideBox-item-icon flaticon2-supermarket" style="color: #00aaff;"></i>
					    <span class="sideBox-item-name"><font size="2">Pesanan</font></span>
					</a>
				</li>
				<li class="col-3 sideBox-item" style="background-color: #ffffff;">
					<a href="<?php echo $config['web']['url'] ?>history/deposit">
						<i class="sideBox-item-icon flaticon-bell" style="color: #00aaff;"></i>
					    <span class="sideBox-item-name"><font size="2">Invoice</font></span>
					</a>
				</li>
	    	</ul>
		</nav>
