...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
        ...
        <meta content="PANEL SMM INDONESIA" name="DYPEDIA STORE" />
        ...
        <link href="<?php echo $config['web']['url'] ?>assets/css/select2.min.css" rel="stylesheet" />
...
<script type="text/javascript">window.$crisp=[];window.CRISP_WEBSITE_ID="80247568-ae5d-4e8c-9646-32844573dc3d";(function(){d=document;s=d.createElement("script");s.src="https://client.crisp.chat/l.js";s.async=1;d.getElementsByTagName("head")[0].appendChild(s);})();</script>
...
<style>
    ...
    box-shadow: 0 0 0px -5px rgb(0 0 0 / 75%);
}
...
?>
        ...
        <!-- Start Body -->
        <body  style="background-image: url(<?php echo $config['web']['url'] ?>assets/media/bg/bg-5.png); background-position: center top; background-size: 100% 79px;"  class="kt-page--loading-enabled kt-page--loading kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header--minimize-menu kt-header-mobile--fixed kt-subheader--enabled kt-subheader--transparent kt-page--loading">
        ...
        <div id="kt_header_mobile" class="kt-header-mobile  kt-header-mobile--fixed">
	        <div class="kt-header-mobile__logo">
		        <a href="<?php echo $config['web']['url'] ?>">
			        <!--img alt="Logo" src="<?php echo $config['web']['tit'] ?>assets/media/logos/logo.png" style="width: 47px; height: 32;"/-->
		        </a>
	        </div>
        ...
        <div class="kt-header__brand kt-grid__item" id="kt_header_brand">
	        <a class="kt-header__brand-logo" href="<?php echo $config['web']['url'] ?>">
		        <!--<img alt="Logo" src="<?php echo $config['web']['url'] ?>assets/media/logos/logo.png" style="width: 59px; height: 40;" class="kt-header__brand-logo-default"/>-->
		        <!--<img alt="Logo" src="<?php echo $config['web']['url'] ?>assets/media/logos/logo.png" style="width: 47px; height: 32;" class="kt-header__brand-logo-sticky"/>-->
	        </a>		
        </div>
        <!-- End Brand -->
            ...
            <div id="kt_header_menu" class="kt-header-menu kt-header-menu-mobile">
                <ul class="kt-menu__nav">
                    ...
                    <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--rel" data-ktmenu-submenu-toggle="click" aria-haspopup="true">
                        <a href="<?php echo $config['web']['url'] ?>admin" class="kt-menu__link"><span class="kt-menu__link-text">Ruang Admin</span>
                        </a>
                    </li>
                    <?php } ?>
                    <?php
                    ...
                    <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--rel" data-ktmenu-submenu-toggle="click" aria-haspopup="true">
                        <a  href="javascript:;" class="kt-menu__link kt-menu__toggle">
                            <span class="kt-menu__link-text">Menu Spesial &nbsp;<i class="fa fa-angle-down"></i></span>
                        </a>
                    ...
                    <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--rel" data-ktmenu-submenu-toggle="click" aria-haspopup="true">
                        <a  href="javascript:;" class="kt-menu__link kt-menu__toggle">
                            <span class="kt-menu__link-text">Informasi &nbsp;<i class="fa fa-angle-down"></i></span>
                        </a>
                        <div class="kt-menu__submenu kt-menu__submenu--classic kt-menu__submenu--left">
                            <ul class="kt-menu__subnav">
                                <li class="kt-menu__item  kt-menu__item--submenu" data-ktmenu-submenu-toggle="hover" aria-haspopup="true">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active show" id="topbar_notifications_notifications" role="tabpanel">
                            <div class="kt-notification kt-margin-t-10 kt-margin-b-10 kt-scroll" data-scroll="true" data-height="300" data-mobile-height="200">
                                <?php 
                                $cek_saldo = $conn->query("SELECT * FROM riwayat_saldo_koin WHERE username = '$sess_username' ORDER BY id DESC LIMIT 1000");
                        ...
                        <div class="tab-pane" id="topbar_notifications_logs" role="tabpanel">
                            <div class="kt-notification kt-margin-t-10 kt-margin-b-10 kt-scroll" data-scroll="true" data-height="300" data-mobile-height="200">
                                <?php 
                                $cek = $conn->query("SELECT * FROM semua_pembelian WHERE user = '$sess_username' ORDER BY id DESC LIMIT 1000");
