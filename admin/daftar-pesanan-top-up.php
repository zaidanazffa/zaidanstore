...
require '../lib/session_login_admin.php';
        ...
        if (isset($_POST['ubah'])) {
            ...
            if ($cek_orders->num_rows == 0) {
                ...
                if ($conn->query("UPDATE pembelian_pulsa SET status = '$status', keterangan = '$keterangan'  WHERE oid = '$get_oid'") == true) {
                    if ($status == "Success") {
                            ...
                            <div class="kt-iconbox__body">
                                ...
                                <div class="kt-iconbox__desc text-left">
                                    ...
                                    <div class="kt-iconbox__content">
                                        <font color="white">Total Pemesanan Top Up Pengguna</font>
                                    </div>
                                </div>
                            </div>
                        </div>
