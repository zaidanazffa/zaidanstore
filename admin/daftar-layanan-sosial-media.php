...
if (isset($_GET['search'])) {
    ...
    $cek_layanan = "SELECT * FROM layanan_sosmed WHERE layanan LIKE '%$search%' ORDER BY harga ASC"; // edit
} else {
    $cek_layanan = "SELECT * FROM layanan_sosmed ORDER BY harga ASC"; // edit
}
if (isset($_GET['search'])) {
