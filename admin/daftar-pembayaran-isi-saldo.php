                            ...
                            <div class="modal-body">
                                <form class="form-horizontal" role="form" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" name="provider" class="form-control" placeholder="Contoh : BNI, Telkomsel, XL, OVO">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" name="nama_penerima" class="form-control" placeholder="Contoh : A/n Sultan Farhan">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12 control-label">Tujuan Transfer</label>
                                        <div class="col-md-12">
                                            <input type="number" name="tujuan" class="form-control" placeholder="Contoh : 082272735700">
                                        </div>
                                    </div>
                                    <div class="form-group">
