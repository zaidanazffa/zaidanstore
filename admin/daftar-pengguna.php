...
require '../lib/session_login_admin.php'; 
        ...
        if (isset($_POST['tambah'])) {
            ...
            if (!$nama_depan || !$nama_belakang || !$email || !$no_hp || !$username || !$password || !$level || !$pin) {
                ...
                if ($conn->query("INSERT INTO users VALUES ('', '$nama_depan', '$nama_belakang', '$nama_depan $nama_belakang', '$email', '$username', '$hash_pass', '$saldo_sosmed', '$saldo_top_up', '0', '$level', 'Aktif', 'Sudah Verifikasi', '$pin', '$api_key', '$sess_username', '$sess_username', '$date', '$time', '0', '$no_hp', '', 'PRIME-$kode_referral', '', '', '')") == true) {
                        ...
                        <div class="kt-portlet__body">
                            <div class="kt-iconbox__body">
                                ...
                                <div class="kt-iconbox__desc text-left">
                                    ...
                                    <div class="kt-iconbox__content">
                                        <font color="white">Saldo Sosmed Rp <?php echo number_format($total_saldo_sosmed_pengguna['total'],0,',','.'); ?></font>
                                    </div>
                                    <div class="kt-iconbox__content">
                                        <font color="white">Saldo Sosmed Rp <?php echo number_format($total_saldo_top_up_pengguna['total'],0,',','.'); ?></font>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form class="form-horizontal" role="form" method="POST">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-12 control-label">Saldo Top Up</label>
                                        <div class="col-md-12">
                                            <input type="number" name="saldo_top_up" class="form-control" placeholder="Saldo Top Up">
                                        </div>
                                    </div>
                                    <div class="form-group">
...
?>                                        
                                <tr>
                                    ...
                                    <td width="5%"><span class="badge badge-warning">Rp <?php echo number_format($data_pengguna['pemakaian_saldo'],0,',','.'); ?></span></td>
