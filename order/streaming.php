			    ...
			    if ($provider == "DG-PULSA" && $json_result['data']['status'] == "Gagal") {
			        ...
			        if ($provider == "DG-PULSA") {
						...
						if ($conn->query("INSERT INTO pembelian_pulsa VALUES ('','$order_id', '$provider_oid', '$sess_username', '".$data_layanan['layanan']."', '".$data_layanan['harga']."', '".$data_rate['rate']."', '$koin', '$post_target', '', 'Pending', '$date', '$time', 'Website', '$provider', '0')") == true) {
							...
							$conn->query("INSERT INTO riwayat_saldo_koin VALUES ('', '$sess_username', 'Saldo', 'Pengurangan Saldo', '".$data_layanan['harga']."', 'Mengurangi Saldo Top Up Melalui Pemesanan Streaming Dengan Kode Pesanan : WEB-$order_id', '$date', '$time')");
...
?>
        ...
        <!-- Start Page New Orders Streaming -->
        <div class="row">
	        <div class="col-lg-7">
	        ...
	        <div class="col-lg-5">
		        <div class="kt-portlet">
			        ...
			        <div class="kt-portlet__body">
						<ul>
							<li>Pesan Streaming Masukkan Nomor HP/Email Dengan Benar, Contoh 082272735700 atau sultanfarh4n@gmail.com</li>
