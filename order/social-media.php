				    ...
				    $_SESSION['hasil'] = array('alert' => 'danger', 'pesan' => 'Ups, '.$json_result['data']['pesan']);
                     ...
                     if ($provider == "SULTAN") {
			            ...
			            if ($provider_oid == "provider_oid") {
					        $_SESSION['hasil'] = array('alert' => 'danger', 'pesan' => 'Ups, Gagal! Sistem Kami Sedang Mengalami Gangguan.<script>swal("Ups Gagal!", "Sistem Kami Sedang Mengalami Gangguannnnn.", "error");</script>');
		        ...
		        <div class="kt-portlet">
			        ...
			        <div class="kt-portlet__body">
						<ul>
							...
							<li>Apabila Pesanan Tidak Mengalami Perubahan Status, Silahkan Hubungi Kontak Admin Untuk Di Selesaikan.</li>
