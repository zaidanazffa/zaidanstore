...
require '../lib/session_user.php';
		...
		if (isset($_POST['pesan'])) {
			...
			$post_count = $conn->real_escape_string(filter($_POST['count']));
	        ...
	        if (empty($post_count)) {
			    $error ['count'] = '*Tidak Boleh Kosong.';
	        }
	        if (empty($post_pin)) {
			    ...
			    if ($provider == "SULTAN" AND $json_result['status'] == false) {
			        ...
			        if ($provider == "SULTAN") {
						...
						if ($conn->query("INSERT INTO pembelian_pulsa VALUES ('','$order_id', '$provider_oid', '$sess_username', '".$data_layanan['layanan']."', '".$data_layanan['harga']."', '".$data_rate['rate']."', '$koin', '$post_target', '', 'Pending', '$date', '$time', 'Website', '$provider', '0')") == true) {
							...
							$conn->query("INSERT INTO riwayat_saldo_koin VALUES ('', '$sess_username', 'Saldo', 'Pengurangan Saldo', '".$data_layanan['harga']."', 'Mengurangi Saldo Top Up Melalui Pemesanan Pulsa Reguler Dengan Kode Pesanan : WEB-$order_id', '$date', '$time')");
...
?>
        ...
        <!-- Start Page New Orders Pulsa Reguler -->
        <div class="row">
	        <div class="col-lg-7">
                        ...
                        <form class="form-horizontal" method="POST">
							...
							<div class="form-group row">
								...
								<div class="col-lg-9 col-xl-6">
								    <input type="text" name="target" id="target" class="form-control" placeholder="Nomor HP">
	        ...
	        <div class="col-lg-5">
		        <div class="kt-portlet">
			        ...
			        <div class="kt-portlet__body">
						<ul>
							<li>Pesan Pulsa Reguler Masukkan Nomor HP Dengan Benar, Contoh 081329324065.</li>
		...
		<!-- End Page New Orders Pulsa Reguler -->
		...
		$(document).ready(function() {
		    $("#target").keyup(function() {
		        ...
		        $.ajax({
			        url: '<?php echo $config['web']['url']; ?>ajax/detector/pulsa.php',
			        data: 'target=' + target,
			        type: 'POST',
			        dataType: 'html',
