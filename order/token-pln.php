...
require '../lib/session_user.php';
		...
		if (isset($_POST['pesan'])) {
		    ...
		    if ($provider == "MANUAL") {
                ...
                $api_postdata = "api_key=$api_key&action=pemesanan&layanan=$post_layanan&target=$post_target";
			    ...
			    if ($provider == "SULTAN" AND $json_result['status'] == false) {
			        ...
			        if ($provider == "SULTAN") {
						...
						if ($conn->query("INSERT INTO pembelian_pulsa VALUES ('','$order_id', '$provider_oid', '$sess_username', '".$data_layanan['layanan']."', '".$data_layanan['harga']."', '".$data_rate['rate']."', '$koin', '$post_target', '', 'Pending', '$date', '$time', 'Website', '$provider', '0')") == true) {
							...
							$conn->query("INSERT INTO riwayat_saldo_koin VALUES ('', '$sess_username', 'Saldo', 'Pengurangan Saldo', '".$data_layanan['harga']."', 'Mengurangi Saldo Top Up Melalui Pemesanan Token PLN Dengan Kode Pesanan : WEB-$order_id', '$date', '$time')");
...
?>
        ...
        <!-- Start Page New Orders Token PLN -->
        <div class="row">
	        <div class="col-lg-7">
		        <div class="kt-portlet">
                    ...
                    ?>
                        <form class="form-horizontal" method="POST">
							...
							<div class="form-group row">
								<label class="col-xl-3 col-lg-3 col-form-label">Operator</label>
								<div class="col-lg-9 col-xl-6">
							...
							<div class="form-group row">
								...
								<div class="col-lg-9 col-xl-6">
								    <input type="text" name="target" class="form-control" placeholder="Nomor PLN/Pelanggan">
	        ...
	        <div class="col-lg-5">
		        <div class="kt-portlet">
			        ...
			        <div class="kt-portlet__body">
						<ul>
							<li>Pesan Token PLN Masukkan Nomor PLN Dengan Benar, Contoh 331316783616.</li>
							<li>Harap Masukan Nomor PLN Dengan Benar, Tidak Ada Pengembalian Dana Untuk Kesalahan Pengguna Yang Pesanannya Sudah Terlajur Di Pesan.</li>
