			    ...
			    if ($provider == "SULTAN" AND $json_result['status'] == false) {
			        ...
			        if ($provider == "SULTAN") {
						...
						if ($conn->query("INSERT INTO pembelian_pulsa VALUES ('','$order_id', '$provider_oid', '$sess_username', '".$data_layanan['layanan']."', '".$data_layanan['harga']."', '".$data_rate['rate']."', '$koin', '$post_target', '', 'Pending', '$date', '$time', 'Website', '$provider', '0')") == true) {
							...
							$conn->query("INSERT INTO riwayat_saldo_koin VALUES ('', '$sess_username', 'Saldo', 'Pengurangan Saldo', '".$data_layanan['harga']."', 'Mengurangi Saldo Top Up Melalui Pemesanan Voucher Game Dengan Kode Pesanan : WEB-$order_id', '$date', '$time')");
...
?>
        ...
        <!-- Start Page New Orders Voucher Game -->
        <div class="row">
	        <div class="col-lg-7">
                    ...
                    ?>
                        <form class="form-horizontal" method="POST">
							...
							<div class="form-group row">
								...
								<div class="col-lg-9 col-xl-6">
								    <input type="text" name="target" class="form-control" placeholder="ID Game">
	        ...
	        <div class="col-lg-5">
		        <div class="kt-portlet">
			        ...
			        <div class="kt-portlet__body">
						<ul>
							<li>Pesan Voucher Game Masukkan ID Game Dengan Benar, Contoh 32141453.</li>
							<li>Harap Masukan ID Game Dengan Benar, Tidak Ada Pengembalian Dana Untuk Kesalahan Pengguna Yang Pesanannya Sudah Terlajur Di Pesan.</li>
		...
		<!-- End Page New Orders Voucher Game -->
